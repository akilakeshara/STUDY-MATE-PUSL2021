...
class SponsorChatWithAdminScreen extends StatefulWidget {
  const SponsorChatWithAdminScreen({super.key});

  @override
  State<SponsorChatWithAdminScreen> createState() =>
      _SponsorChatWithAdminScreenState();
}

class _SponsorChatWithAdminScreenState
    extends State<SponsorChatWithAdminScreen> {
              ...
              builder: (context, snapshot) {
                    ...
                    child: Container(
                      ...
                      child: const Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 10),
                          Text(
                            'Hi! Send a message to the admin team.',
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final bool isMe = data['isAdmin'] == false;
